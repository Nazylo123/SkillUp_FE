...
@Component({
    ...
    imports: [RouterLink, MatCardModule, MatButtonModule, MatMenuModule, MatTableModule, MatCheckboxModule, MatTooltipModule, MatPaginatorModule, PtOverviewComponent, PtCompletedComponent, PtPerformanceComponent],

...
@Component({
    selector: 'app-lecturer-final-quiz',
    imports: [MatTableModule, MatIconModule, MatButtonModule, MatCard, MatCardHeader, MatCardContent],
...
export class LecturerFinalQuiz {
